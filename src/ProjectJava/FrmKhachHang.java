...
public class FrmKhachHang extends JPanel{
    ...
    private boolean kiemTraDiem(String diemStr) {
    try {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (!kiemTraDiem(txtDiem.getText().trim())) {
            JOptionPane.showMessageDialog(this, "Điểm tích lũy phải là số ≥ 0");
            return;
        }

    try {
        String sql = "INSERT INTO KhachHang (tenkh, sdt, diachi, diemtichluy) VALUES (?,?,?,?)";
        ...
        ps.setInt(4, Integer.parseInt(txtDiem.getText()));
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        ps.setString(3, txtDiaChi.getText());
        ps.setInt(4, Integer.parseInt(txtDiem.getText()));
        ps.setInt(5, Integer.parseInt(txtMaKH.getText()));
    ...
    try {
        ...
        StringBuilder sql = new StringBuilder(
            "SELECT * FROM KhachHang WHERE 1=1"
        );
        ...
        if (!txtDiem.getText().trim().isEmpty()) {
            sql.append(" AND diemtichluy = ?");
            params.add(Integer.parseInt(txtDiem.getText().trim()));
        }
        Connection conn = DBConnection.getConnection();
        ...
        while (rs.next()) {
            ...
            String loai;
            if (diem >= 500) loai = "Kim cương";
            else if (diem >= 300) loai = "Vàng";
            else if (diem >= 100) loai = "Bạc";
            else loai = "Thường";
    ...
    txtDiem.setText(tblKhachHang.getValueAt(row, 4).toString());
